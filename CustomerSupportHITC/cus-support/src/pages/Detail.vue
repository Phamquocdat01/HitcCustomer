          ...
          <div class="row">
            <div class="col-12 col-md-12">
              <q-select
                ...
                lazy-rules
                :rules="[
                  (va) => (val && val.length > 0) || 'Hãy chọn loại vấn đề',
                ]"
              />
            </div>
          </div>
          <div class="row">
            <div class="col-12 col-md-6">
              <q-select
                ...
                lazy-rules
                :rules="[
                  (val) => (val && val.length > 0) || 'Hãy chọn mức độ ưu tiên',
                ]"
              />
            </div>
            <div class="col-12 col-md-6">
              <q-select
                ...
                lazy-rules
                :rules="[
                  (val) => (val && val.length > 0) || 'Hãy chọn tình trạng',
                ]"
              />
            </div>
          </div>
          <div class="row">
            <div class="col-12 col-md-6">
              <q-input
                ...
                lazy-rules
                :rules="[
                  (val) => (val && val.length > 0) || 'Hãy nhập số điện thoại',
                ]"
              />
            </div>
          </div>
          <div class="row">
            <div class="col-12 col-md-12">
              <q-input
                ...
                lazy-rules
                :rules="[
                  (val) => (val && val.length > 0) || 'Hãy nhập tên khách hàng',
                ]"
              />
            </div>
          </div>
        ...
        <div class="col-12 col-md-4">
          ...
          <div class="row">
            <div class="col-12 col-md-12">
              <q-input
                ...
                lazy-rules
                :rules="[
                  (val) => (val && val.length > 0) || 'Hãy nhập người xử lý',
                ]"
              />
            </div>
          </div>
          <div class="row">
            <div class="col-12 col-md-12">
              <q-input
                ...
                lazy-rules
                :rules="[
                  (val) => (val && val.length > 0) || 'Hãy nhập người tạo',
                ]"
              />
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-12 col-md-12">
              <q-input
                filled
                v-model="modelAdd.NgayHoanThanh"
                mask="date"
                :rules="['date']"
...
export default defineComponent({
  ...
  methods: {
    onSubmit() {
      api.insertdata(this.modelAdd).then(() =>
        this.$q
          .notify({
            type: "positive",
    ...
    async getDataLoaiVanDe() {
      let response;
      response = await api.getAllDataLoaiVanDe().then(() =>
        this.$q
          .notify({
            type: "positive",
